...
<template>
    <div class="flex gap-2">
        <button
            class="flex-1 flex flex-col items-center py-2 px-0 bg-white border border-alabaster-grey shadow rounded-xl cursor-pointer transition-all duration-300 text-gray-500 hover:bg-alabaster-grey hover:border-mint-leaf hover:text-evergreen w-[50%]"
